...
class MISOLoadModel(LoadCorrectionModel):
    ...
    def predict_with_uncertainty(
        ...
        for i, _ in enumerate(forecast_dates):
            ...
            if temps_c:
                forecast_avg_f.append(weighted_avg_temp_f_miso(temps_c))
            else:
        ...
        for i, d in enumerate(forecast_dates):
            ...
            if avg_f is None:
                continue
            hi_f = weighted_avg_temp_f_miso(hi_c_map) if hi_c_map else avg_f
            lo_f = weighted_avg_temp_f_miso(lo_c_map) if lo_c_map else avg_f
